...
def add_new_room(request):
    ...
    if request.method == "POST":
        ...
        new_room.image      = request.FILES.get('image')
        ...
        print('new image ' ,new_room.image)
...
def delete_booking(request):
    ...
    if request.method =="GET":
        ...
        if booking_id is None:
            return HttpResponseBadRequest("Missing booking id parameter")
        print(booking_id)
        
        Reservation.objects.filter(id=booking_id).delete()
